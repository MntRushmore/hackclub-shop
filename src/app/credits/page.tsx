                        ...
                        <div className="space-y-6">
                            ...
                            <div>
                                ...
                                <p className="text-hackclub-slate font-medium text-sm mb-3">
                                    <span className="text-hackclub-red font-bold">Required:</span> Enter <span className="font-mono font-bold bg-hackclub-smoke px-2 py-1 rounded">{claimCode}</span> in your name
                                </p>
                                <motion.a
