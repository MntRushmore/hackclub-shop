...
import { formatCash, formatPoints } from '../../lib/paymentUtils';
                    ...
                    >
                      <div className="flex gap-4">
                        ...
                        <div className="flex-1">
                          ...
                          <p className="font-bold text-hackclub-red">
                            {isStudent
                              ? formatPoints((item.price_points || 0) * item.quantity)
                              : formatCash((item.price_cash || 0) * item.quantity)}
                          </p>
