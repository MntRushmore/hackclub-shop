...
const TIERS = [
    {
        ...
        amount: 25,
        fmvCents: 500,
        impact: "Enough to cover a teen's domain and dev tools for a year.",
        description: "Back a teenager with a $25 donation. As our thanks, a Hack Club sticker pack. That's enough to cover a teen's domain and dev tools for a year.",
    ...
    },
    {
        ...
        amount: 100,
        fmvCents: 3000,
        impact: 'Enough to get a teen to their first hackathon, where they find their people.',
        description: "Back a teenager with a $100 donation. As our thanks, your choice of the Hack Club mug or tote. That's enough to get a teen to their first hackathon.",
        variants: [
    ...
    },
    {
        ...
        amount: 150,
        fmvCents: 3500,
        impact: "Enough to fund a teen's first hardware project grant.",
        description: "Back a teenager with a $150 donation. As our thanks, your choice of the Hack Club tee or cap. That's enough to fund a teen's first hardware project grant.",
        variants: [
    ...
    },
    {
        ...
        amount: 250,
        fmvCents: 8000,
        impact: 'Enough to back a teen through a summer of building.',
        description: `Back a teenager with a $250 donation. As our thanks, the College sweatshirt or the "Mom" sweatshirt, plus a sticker pack. That's enough to back a teen through a summer of building.`,
        variants: [
    ...
    },
    {
        ...
        amount: 500,
        fmvCents: 10000,
        impact: 'Enough to put a laptop in the hands of a teen coding on a school Chromebook.',
        description: "Back a teenager with a $500 donation. As our thanks, the numbered Hack Club vest (only 100 will ever be made) plus a sticker pack. That's enough to put a laptop in the hands of a teen coding on a school Chromebook.",
    ...
    },
    {
        ...
        amount: 1000,
        fmvCents: 29000,
        impact: "Enough to sponsor a teen's entire year of laptops, travel, and grants.",
        description: "Sponsor a teenager's entire year with a $1,000 donation. As our thanks, the full kit: numbered vest, sweatshirt, tee, cap, mug, tote, and stickers. Pick your vest size here and we'll email you to confirm sizes for the rest.",
